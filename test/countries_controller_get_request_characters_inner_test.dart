...
// tests for CountriesControllerGetRequestCharactersInner
void main() {
  final instance = CountriesControllerGetRequestCharactersInnerBuilder();
  // TODO add properties to the builder and call build()

  group(CountriesControllerGetRequestCharactersInner, () {
    // String id
