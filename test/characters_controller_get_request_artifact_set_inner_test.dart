...
// tests for CharactersControllerGetRequestArtifactSetInner
void main() {
  final instance = CharactersControllerGetRequestArtifactSetInnerBuilder();
  // TODO add properties to the builder and call build()

  group(CharactersControllerGetRequestArtifactSetInner, () {
    // String id
