# karasu_lab_public_client_dart (EXPERIMENTAL)
...
```yaml
dependencies:
  karasu_lab_public_client_dart: 1.4.0
```
...
dependencies:
  karasu_lab_public_client_dart:
    path: /path/to/karasu_lab_public_client_dart
```
...
```dart
import 'package:karasu_lab_public_client_dart/karasu_lab_public_client_dart.dart';
