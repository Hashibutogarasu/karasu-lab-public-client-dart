# karasu256_api_public_client (EXPERIMENTAL)
...
```yaml
dependencies:
  karasu256_api_public_client: 1.4.0
```
...
dependencies:
  karasu256_api_public_client:
    path: /path/to/karasu256_api_public_client
```
...
```dart
import 'package:karasu256_api_public_client/karasu256_api_public_client.dart';
