...
part 'characters_controller_get_request_version.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class CharactersControllerGetRequestVersion implements Built<CharactersControllerGetRequestVersion, CharactersControllerGetRequestVersionBuilder> {
  ...
  CharactersControllerGetRequestVersion._();

  factory CharactersControllerGetRequestVersion([void updates(CharactersControllerGetRequestVersionBuilder b)]) = _$CharactersControllerGetRequestVersion;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CharactersControllerGetRequestVersionBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CharactersControllerGetRequestVersion> get serializer => _$CharactersControllerGetRequestVersionSerializer();
}

class _$CharactersControllerGetRequestVersionSerializer implements PrimitiveSerializer<CharactersControllerGetRequestVersion> {
  @override
  final Iterable<Type> types = const [CharactersControllerGetRequestVersion, _$CharactersControllerGetRequestVersion];

  @override
  final String wireName = r'CharactersControllerGetRequestVersion';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CharactersControllerGetRequestVersion object, {
  ...
  void _deserializeProperties(
    ...
    required CharactersControllerGetRequestVersionBuilder result,
  ...
  @override
  CharactersControllerGetRequestVersion deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CharactersControllerGetRequestVersionBuilder();
