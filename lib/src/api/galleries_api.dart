...
class GalleriesApi {
  ...
  Future<Response<Gallery>> galleriesControllerCreate({ 
    required GalleriesControllerCreateRequest galleriesControllerCreateRequest,
    ...
    try {
      const _type = FullType(GalleriesControllerCreateRequest);
      _bodyData = _serializers.serialize(galleriesControllerCreateRequest, specifiedType: _type);
