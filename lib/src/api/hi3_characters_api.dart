...
class Hi3CharactersApi {
  ...
  const Hi3CharactersApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<HI3Characters>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<HI3Characters>>> hi3CharactersControllerGet({ 
    ...
    final _path = r'/wiki/public/honkai_impact_3rd/hi3_characters/get';
    ...
    BuiltList<HI3Characters>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(HI3Characters)]),
      ) as BuiltList<HI3Characters>;
    ...
    return Response<BuiltList<HI3Characters>>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<HI3Characters>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<HI3Characters>>> hi3CharactersControllerGetAll({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/wiki/public/honkai_impact_3rd/hi3_characters';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<HI3Characters>> hi3CharactersControllerGetOne({ 
    ...
    final _path = r'/wiki/public/honkai_impact_3rd/hi3_characters/getOne';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    HI3Characters? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HI3Characters),
      ) as HI3Characters;
